...
namespace CGUNS.Primitives
{
    class Cube
    {
        ...
        // Cubo de largo, alto y profundidad igual a (s,r,t)
        public Cube( float s = 1.0f, float r = 1.0f, float t = 1.0f )
        {
            vPos = new Vector3[8];
            vPos[0] = new Vector3(s, r, 0.0f);
            vPos[1] = new Vector3(s, 0.0f, 0.0f);
            vPos[2] = new Vector3(0.0f, 0.0f, 0.0f);
            vPos[3] = new Vector3(0.0f, r, 0.0f);

            vPos[4] = new Vector3(s, r, t);
            vPos[5] = new Vector3(s, 0.0f, t);
            vPos[6] = new Vector3(0.0f, 0.0f, t);
            vPos[7] = new Vector3(0.0f, r, t);
